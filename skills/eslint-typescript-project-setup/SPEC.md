# ESLint TypeScript Project Setup Specification

## Intent

Maintain focused ESLint setup conventions for TypeScript Node.js projects split from the removed broad Node.js project setup skill.
...
- Keep trigger wording precise for ESLint dependencies, .eslintrc.cjs, TypeScript ESLint, Node, import, regexp, jsdoc, unicorn, or eslint-comments rules.

Out of scope:

- Prettier, Vitest, pnpm, or tsconfig setup.
...
- Common user requests: add, edit, standardize, or review ESLint dependencies, .eslintrc.cjs, TypeScript ESLint, Node, import, regexp, jsdoc, unicorn, or eslint-comments rules.
...
- The split intentionally preserves existing recommendations, including any stale versions.
